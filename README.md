...
```
**3)** [Classifier](android/app/src/main/java/com/example/handwritten_digit_classifier/Classifier.kt) reads the mnist.tflite from assets directory and loads it into an tflite-Interpreter for inference. 
```kotlin
